...
class finetuning(object):
    def __init__(self
        ...
        #deep copy
        self.Mz_FT1=copy.copy(Mz_FT1)
        self.Mz_FT2=copy.copy(Mz_FT2)
        self.Mz_FT3=copy.copy(Mz_FT3)
        self.Mz_FT4=copy.copy(Mz_FT4)
        self.Mz_FT5=copy.copy(Mz_FT5)
        self.Mz_FT6=copy.copy(Mz_FT6)
        self.Mz_FT7=copy.copy(Mz_FT7)
        self.Mz_FT8=copy.copy(Mz_FT8)
        self.mh_FT1=copy.copy(MH_FT1)
        self.mh_FT2=copy.copy(MH_FT2)
        self.mh_FT3=copy.copy(MH_FT3)
        self.mh_FT4=copy.copy(MH_FT4)
        self.mh_FT5=copy.copy(MH_FT5)
        self.mh_FT6=copy.copy(MH_FT6)
        self.mh_FT7=copy.copy(MH_FT7)
        self.mh_FT8=copy.copy(MH_FT8)
